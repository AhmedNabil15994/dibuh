...
{{ trans('backend/account.create_new') }}
@endsection
    ...
    <div class="col-xs-12 col-sm-12 col-md-12">        
        <div class="box box-info">
            ...
            <div class="box-header with-border">
                <h3 class="box-title">{{ trans('backend/account.create_new') }}</h3>
            </div>
            ...
            @endif
            {!! Form::open(array('route' => 'admin::account.store','method'=>'POST')) !!}
            <div class="box-body">    
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        (['' =>  trans('master.select_item_from_list') ] + $parent), 
                        null, 
