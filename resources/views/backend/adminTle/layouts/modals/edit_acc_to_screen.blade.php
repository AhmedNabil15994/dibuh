<div id="edit-accscreen-modal" class="modal fade">
    <div class="modal-dialog" >
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">×</button>
                <h4 class="modal-title">{{ trans('backend/account_to_screen.edit') }}</h4>
            </div>
             @if (count($errors) > 0)
            ...
            @permission('account-edit')
                ...
                <div class="modal-body">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            <div class="col-sm-4">
                                <strong>{{ trans('backend/account.screen')}} :</strong>
                            </div>
                    <div class="col-sm-8">       
                            @foreach ($screens as $key=>$val) <!--$role variable gets its data from the db-->
                             <div class="row" style="margin-bottom: 10px;">   
                                <div class="col-sm-6" style="display: inline-block;">
                                    ...
                                    <input type="checkbox" name="screen_type" value1="{{$val->id}}" value2="{{$val->name}}" class="icheckbox_flat">
                             </div>  
                            @endforeach
                    </div>         
            ...
            {!! Form::open(['method' => 'POST','route' => ['admin::account_to_screen.editAccScreen'], 'style'=>'display:inline']) !!} 
