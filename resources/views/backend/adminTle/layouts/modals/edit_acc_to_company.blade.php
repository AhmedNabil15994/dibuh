<div id="edit-acccompany-modal" class="modal fade">
    <div class="modal-dialog" >
        <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            @foreach ($company as $key=>$val) <!--$role variable gets its data from the db-->
                                
                                    <label>{{$val->name}}</label>
                                    <input type="checkbox" name="company_type" value1="{{$val->id}}" value2="{{$val->name}}" class="icheckbox_flat">
            ...
            {!! Form::open(['method' => 'POST','route' => ['admin::account_to_companytype.editAccCompany'],'style'=>'display:inline']) !!} 
