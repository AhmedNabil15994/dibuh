...
Route::group([ 'namespace' => 'Frontend\Dashboard\User', 'prefix' => 'dashboard'], function() {
    ...
    Route::group(['middleware' => [ 'App\Http\Middleware\UserRoutingMiddleware', 'status.inactive']], function () {
        ...
        Route::group(['prefix' => 'abstract'], function () {
            ...
            Route::patch('update/{id}', ['as' => 'abstract.update', 'uses' => 'AbstractController@update']);
        ...
        Route::group(['prefix' => 'report'], function () {
			...
			Route::get('log', ['as' => 'report.log', 'uses' => 'ReportController@log']);
            //ajax request
...
Route::group(['namespace' => 'Frontend'], function() {
    ...
    Route::group(['namespace' => 'Auth'], function() {
        ...
        Route::post('register', ['as' => 'register', 'uses' => 'AuthWebController@postRegister']);
