...
<div class="row">
    <div class="col-lg-12 margin-tb">
        ...
        <div class="pull-right">
            ...
            <a class="btn btn-success btn-md" href="{{ route('admin::category.create') }}"><i class="fa fa-plus"></i> {{ trans('button.create') }}</a> 
            @endpermission
        </div>
    </div>
</div>
<table class="table table-bordered deleteFormModal" data-form="deleteForm">
    ...
    <tr>
        ...
        <td>
           ...
           <a class="btn btn-primary btn-xs" href="{{ route('admin::category.edit',$accountCategory->id) }}"><i class="fa fa-edit"></i> {{ trans('button.edit') }}</a>
            @endpermission
 
            @permission('account-delete')
            {!! Form::open(['method' => 'DELETE','route' => ['admin::category.destroy', $accountCategory->id], 'class' =>' form-delete','style'=>'display:inline']) !!}
