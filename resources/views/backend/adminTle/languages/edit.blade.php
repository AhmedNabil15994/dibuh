    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="box box-info">
            ...
            <div class="box-header with-border">
                <h3 class="box-title">{{ trans('backend/language.edit') }}</h3>
            </div>
            ...
            {!! Form::model($data, ['method' => 'PATCH','route' => ['admin::languages.update', $data->id]]) !!}
            ...
            <div class="box-body">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        {!! Form::select('dir', ['ltr'=>'ltr','rtl'=>'rtl'],$data->dir, array('class' => 'form-control')) !!}
            ...
            <div class="box-body">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        {!! Form::select('txt_dir', ['left'=>'left','right'=>'right'],$data->txt_dir, array('class' => 'form-control')) !!}
...
<!--
            ...
            <div class="box-footer">
                <button type="submit" class="btn btn-primary pull-left"><i class="fa fa-save"></i> {{ trans('button.edit') }}</button>
