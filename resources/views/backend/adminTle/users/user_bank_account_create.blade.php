...
{{ trans('backend/user.bank_account_create') }}
@endsection
    ...
    <div class="col-xs-12 col-sm-12 col-md-12">        
        <div class="box box-info">
            ...
            <div class="box-header with-border">
                <h3 class="box-title">{{ trans('backend/user.bank_account_create') }}</h3>
            </div>
            @if (count($errors) > 0)
            ...
            @endif
            {!! Form::open( ['method' => 'POST','route' => ['admin::users.bankaccount.store',$user_id]]) !!}
            ...
            <div class="box-footer">
                <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                    ...
                    <a class="btn btn-danger pull-right" href="{{ route('admin::users.show',$user_id) }}"><i class="fa fa-home "></i>  {{ trans('button.cancel') }}</a>       
                </div>
