...
{{ trans('backend/user.address_create') }}
@endsection
    ...
    <div class="col-xs-12 col-sm-12 col-md-12">        
        <div class="box box-info">
            ...
            <div class="box-header with-border">
                <h3 class="box-title">{{ trans('backend/user.address_create') }}</h3>
            </div>
            @if (count($errors) > 0)
            ...
            @endif
            {!! Form::open( ['method' => 'POST','route' => ['admin::users.profile.address.store',$user_id]]) !!}
