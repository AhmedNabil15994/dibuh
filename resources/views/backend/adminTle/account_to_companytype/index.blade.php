...
{{ trans('backend/account_to_company_type.list') }}
@endsection
        ...
        <div class="box box-info">  
            ...
            <div class="box-header with-border">
                <div class="pull-left">
                     ...
                     <h3 class="box-title">{{ trans('backend/account_to_company_type.list') }}</h3> 
                    ...
                    @endpermission
                        ...
                        <div class="box-body">
                            <table class="table table-borderless deleteFormModal" data-form="deleteForm">
                                <thead>
                                    <tr>
                                        <th>ID</th><th> Account Id </th><th> Company Type Id </th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
...
<!--                                        <td>{{ $item->name }}</td>-->
                                        ...
                                        <td>
                                            ...
                                            <div class="Button btn-md btn-info block pull-left " style="display: block;margin: 3px;padding-right: 5px;padding-left: 2px"> {{$comp_type->name}} </div>  
                                            @endforeach
...
<!--                                                <a href="{{ url('/backend/account_to_companytype/' . $item->id) }}" class="btn btn-success btn-sm" title="View account_to_companytype"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"/></a>-->
                                                ...
                                                <a href="{{ route('admin::account_to_companytype.edit',$item->id)  }}" class="btn btn-primary btn-sm" title="Edit account_to_companytype"><span class="glyphicon glyphicon-pencil" aria-hidden="true"/></a>
                                            @endpermission

                                            @permission('account-delete')
                                                {!! Form::open([
                                                'method'=>'DELETE',
                                                'route' => ['admin::account_to_companytype.destroy', $item->id],
