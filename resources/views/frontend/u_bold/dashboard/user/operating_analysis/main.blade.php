...
@section('content')
    ...
    <div class="row m-b-20 header-print" >
        <div class="col-xs-12 ">
            ...
            <p class="text-muted page-title-alt m-b-0">تحليل مصروفات عامة وادارية 2014</p>
        </div>
    </div>
                ...
                <div class="BoxContent card-box">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th>اصلاح وصيانة</th>
                                <th >رسوم</th>
                                <th colspan="2" >حصة الشركة من التامينات</th>
                                <th >م.بنكية</th>
                                <th >م.تحليل مياة</th>
                                <th >اكراميات</th>
                                <th >اهلاك</th>
                                <th colspan="2" >بوفية و ادوات نظافة</th>
                                <th >شحن كهرباء</th>
                                <th colspan="3">ادوات كتابية واحبار</th>
                                <th >اتعاب استشارية</th>
                            </tr>
                        </thead>
                        <div class="tableBody">
                            <tbody>
