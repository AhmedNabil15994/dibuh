                        ...
                        <div class="row">
                            <div class="col-md-6 col-xs-12">
                                <div class="form-group has-feedback ">
                                    ...
                                    <input class="form-control" type="text" name="invoice_number" id="invoice_number" value="{{old('invoice_number') ? old('invoice_number') : $invoice_number}}" placeholder="{{ trans('frontend/sales_invoice.invoice_number')}}" readonly>
...
<!--
                ...
                <div class="row" id="footer-row">
                    <div class="col-md-12 col-xs-12" style="margin-bottom: 15px">
                        <textarea id="footer_text" name="footer_text">{!! old('footer_text') ? old('footer_text') : '' !!}</textarea>
                    </div>
                </div>
...
//            maximumSelectionLength: 1,
    ...
    {{--                var url = "{{ route('sales_invoice.store_draft') }}"; // the script where you handle the form input.--}}
                    $.ajax({
                        type: "POST",
