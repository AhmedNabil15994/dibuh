    ...
    <div class="panel panel-default page-panel">
        <div class="panel-heading">
            <div class="row">
                <div class="col-md-5 pull-right ">
                    ...
                    <div class="btn-group pull-right export" style="margin-top: 5px;">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li>
                            <a> <?php $title=trans('frontend/sales_invoice.title').'.pdf'; ?>
                              {!!Form::open(['class'=>'PdfForm','route'=>'sales_invoice.exportPdf']) !!}
                            ...
                            <li><a href="{{route('sales_invoice.exportExcel')}}">Excel File</a></li>
                            <li><a href="{{route('sales_invoice.exportCsv')}}">Csv File</a></li>
                            <li><a href="{{route('sales_invoice.exportHtml')}}">Html File</a></li>
                        </ul>
                    </div>
                </div>
                {{--'status_All'=>'الكل',--}}
                ...
                {{--'status_Due'=>'مستحقة',--}}
                {{--'status_Paid'=>'مدفوعه',--}}
                {{--'status_Paid'=>'مدفوعه جزئيا ',--}}
                <ul class="panel-nav  pull-left">
                    <li><a  class="active al" id="state-all"    href="javascript:void(0)"  link="{{Route('sales_invoice.get_invoices_with_status',[0])}}">{{trans('frontend/sales_invoice.status_All'   )}}</a></li>
                    <li><a class="al"       id="state-draft"  href="javascript:void(0)"  link="{{Route('sales_invoice.get_invoices_with_status',[1])}}">{{trans('frontend/sales_invoice.status_Draft' )}}</a></li>
                    <li><a class="al"       id="state-unpaid" href="javascript:void(0)"  link="{{Route('sales_invoice.get_invoices_with_status',[2])}}">{{trans('frontend/sales_invoice.status_Unpaid')}}</a></li>
                    <li><a class="al"       id="state-due"    href="javascript:void(0)"  link="{{Route('sales_invoice.get_invoices_with_status',[3])}}">{{trans('frontend/sales_invoice.status_Due'   )}}</a></li>
                    <li><a class="al"       id="state-paid"   href="javascript:void(0)"  link="{{Route('sales_invoice.get_invoices_with_status',[4])}}">{{trans('frontend/sales_invoice.status_Paid'  )}}</a></li>
                    <li><a class="al"       id="state-partly-paid"   href="javascript:void(0)"  link="{{Route('sales_invoice.get_invoices_with_status',[5])}}">{{trans('frontend/sales_invoice.status_Partly_Paid'  )}}</a></li>
                </ul>
            </div>
        </div>
               ...
               <div class="row ">
                   {{--<div class="col-md-2 col-xs-12">--}}
                       {{--<div class="form-group has-feedback ">--}}
                           {{--<label for="filterSearch" class="control-label">{{trans('frontend/dashboard.search'  )}} :</label>--}}
                   ...
                   <div class="col-md-2 col-xs-12">
                       ...
                       {{--<div class="form-group has-feedback ">--}}
                           {{--<label for="filterCustomer" class="control-label">{{trans('frontend/dashboard.customer'  )}} :</label>--}}
        ...
        <div class="panel-footer">
            <div class="row">
                <div class="col-md-4 pull-left">
                    <a class="btn btn-default waves-effect waves-light" href="{{ route('sales_invoice.create') }}">{{trans('frontend/sales_invoice.create_new')}}</a>
                </div>
            </div>
        </div>
    </div>
...
@section('page-scripts')
    ...
    <script>
        ...
        //  console.log("the table"+html);
      //    var myTable = $(html).find('.table');
          //console.log("Selected : " +myTable);
          //$("#demo-foo-filtering").find("td:gt(:last)").remove();
      //  last= $('#demo-foo-filtering').find("td").last().outerHTML;
        function setHtml(){
          document.getElementById("demo-foo-filtering").rows[0].deleteCell(7);
          document.getElementById("demo-foo-filtering").rows[1].deleteCell(7);
          document.getElementById("demo-foo-filtering").rows[2].deleteCell(7);
      //    var row=
          // for(i=0;i<2;i++)
          // document.getElementById("demo-foo-filtering").rows[2].deleteCell(8);
        //  row.deleteCell(8);
                $("table").find("th:last-child, td:last-child").remove();
                      html=document.getElementById("demo-foo-filtering").outerHTML;
                        document.getElementById("tableContent").value=html;
               }
       ...
       jQuery(document).ready(function($) {
            ...
            $('form.PdfForm').submit(function(){
             ...
             $("#demo-foo-filtering").find("th:last-child, td:last-child").remove();
             html=document.getElementById("demo-foo-filtering").outerHTML;
              document.getElementById("tableContent").value=html;
...
//               var page_number = $(this).attr('href').split('page=')[1];
          ...
          $('#state-all , #state-draft , #state-due , #state-paid ,#state-unpaid,#state-partly-paid').click(function () {
