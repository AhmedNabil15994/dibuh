...
@section('content')
    ...
    <form class="form-page-create" role="form" id="idform" method="POST" action="{{ route('other_income.update' , $data->id ) }}">
        {{ csrf_field() }}
        {{method_field('PATCH')}}
    ...
    {!! Form::open(['method' => 'DELETE','route' => ['other_income.destroy', $data->id],'style'=>'display:inline' , 'id'=>'deleteForm' , 'class'=>'hidden']) !!}
    {!! Form::close() !!}
