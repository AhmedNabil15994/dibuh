    ...
    <div class="panel-heading">
        <div class="row">
            ...
            <ul class="panel-nav pull-left">
                ...
                <li><a class="al"       id="state-due"    href="javascript:void(0)"  link="{{Route('other_income.get_invoices_with_status',[3])}}">{{trans('frontend/sales_invoice.status_Due'   )}}</a></li>
                <li><a class="al"       id="state-paid"   href="javascript:void(0)"  link="{{Route('other_income.get_invoices_with_status',[4])}}">{{trans('frontend/sales_invoice.status_Paid'  )}}</a></li>
            </ul>
        </div>
    </div>
                    ...
                    <div class="tableBody">
                        <tbody>
                            ...
                            <tr style="">
                                ...
                                <td>
                                    <div class="btns">
                                    <a class="btn detail-btn btn-primary show_btn hidden waves-effect waves-light" href="{{ route('other_income.show' ,$row->id) }}"><i class="fa fa-vcard"></i>  {{trans('frontend/sales_invoice.show')}}</a>

                                    <a class="btn detail-btn btn-default waves-effect waves-light" href="{{ route('other_income.edit',$row->id) }}"><i class="fa fa-edit"></i> تعديل  </a>
                                    {!! Form::open(['method' => 'DELETE','route' => ['other_income.destroy', $row->id],'style'=>'display:inline']) !!}
    ...
    <div class="panel-footer">
        <div class="row">
            <div class="col-md-4 pull-left">
                <a class="btn btn-default waves-effect waves-light" href="{{ route('other_income.create') }}">   اضافة فاتورة  </a>
            </div>
        </div>
    </div>
</div>
...
//               data = [$('#filterInvoiceNumber').val(),$('#filterCustomer').val(),$('#filterInvoice_date').val(),$('#filterPayment_day').val()];
                var url = "{{Route('other_income.filter')}}" +
