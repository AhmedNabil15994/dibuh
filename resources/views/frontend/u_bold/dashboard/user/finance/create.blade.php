...
<div class="row">
    <div class="col-sm-12">
        ...
        <h4 class="page-title" style="margin-top: -50px;">أضافة خزينة / بنك</h4>
        <p class=" page-title-alt">من هنا يمكنك تحدد واضافة الخزائن والبنوك</p>
    </div>
</div>
 <!-- end row -->

<div class="col-md-offset-1 col-md-10">
    <form action="{{route('finance.store')}}" method="post" id="idform">
        {{ csrf_field() }}
        <div class="panel">
            <div class="panel-body page-create with-padding">
                ...
                <div class="row">
                    <div class="col-xs-12 ">
                        <h3 class="pull-left label label-def" data-toggle="customer-row">أضافة خزينة  / بنك</h3>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-xs-12">
                            <div class="form-group has-feedback ">
                                ...
                                <input class="form-control" type="text"  placeholder="" value="" name="account_owner">
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-xs-12">
                            <div class="form-group has-feedback ">
                                ...
                                <input class="form-control" type="text"  placeholder="" value="" name="treasury_name">
                ...
                <div id="card_details">
                    <div class="row">
                        <div class="col-sm-6 col-xs-12">
                            <div class="form-group has-feedback ">
                                <label class="control-label">صاحب الحساب :</label>
                                <input class="form-control" type="text"  placeholder="" value="" name="credit_owner">
                                <span class="fa fa-user fa-fw form-control-feedback"></span>
                            </div>
                        </div>
                        <div class="col-sm-3 col-xs-12">
