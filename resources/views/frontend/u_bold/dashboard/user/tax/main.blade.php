...
@section('content')
    ...
    <div class="row m-b-20" style="margin-top: 25px;">
        <div class="col-xs-12 ">
            ...
            <p class="text-muted page-title-alt m-b-0">من هنا يمكنك متابعه الضرائب</p>
        </div>
    </div>
        ...
        <div class="panel-heading">
            <div class="row">
                ...
                <ul class="panel-nav pull-left">
                    ...
                    <li><a class="" id="status_mounthly"  href="javascript:void(0)"  link="">ضريبه الخصم والاضافه</a></li>
                    <li><a class="" id="status_quarterly"    href="javascript:void(0)"  link=""> ضريه القيمة المضافة</a></li>
                </ul>
                ...
                <div class="BoxContent card-box">
                        ...
                        <div class="row">
                            <div class="col-xs-4 pull-left" style="margin-top:-50px">
                                <a class="btn btn-default waves-effect waves-light" href="{{ route('tax.create') }}">الاضافة </a>
                            </div>
                        </div>
                </div>
            </div>
