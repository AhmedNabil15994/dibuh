...
@section('content')
    ...
    <div class="row m-b-20 header-print" >
        <div class="col-xs-12 ">
            ...
            <p class="text-muted page-title-alt m-b-0">الميزان العام فى 31 /12 /2014 </p>
        </div>
    </div>
        ...
        <div class="panel-body">
            ...
            <div class="pbody table-responsive">
                <div class="BoxContent card-box">
                        ...
                        <thead>
                            <tr>
                                <th colspan="2">الارصدة فى 31/3/2014</th>
                                <th colspan="2" >الحركة خلال 2016</th>
                                <th colspan="2" >الارصدة فى 1/1/2014</th>
                                <th colspan="2" >الارصدة فى 1/1/2014</th>

                                <th rowspan="2" style="line-height: 4;">البيان</th>
                            </tr>
                            <tr>
                                <th>مدين</th>
                                <th>دائن</th>
                        ...
                        <div class="tableBody">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>-</td>
                                    <td>-</td>
                                   <td>الهيئة القومية للتامينات</td>
                                </tr>
