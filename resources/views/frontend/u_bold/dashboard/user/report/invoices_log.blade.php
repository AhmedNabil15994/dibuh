        ...
        <div class="panel-heading">
            <div class="row">
                ...
                <ul class="panel-nav pull-left">
                    ...
                    <li><a class="active"  href="{{route('log.income')}}">{{trans('frontend/dashboard.invoices')}}</a></li>
                  ...
                  @if(count($add_data) || count($edit_data))
                    @foreach($add_data as $row)
                      <tr>
                        ...
                        <td>تم انشاء فاتورة رقم {{$row['invoice_number']}} ({{$row['invoice_type']}})</td>
                      </tr>
                    @endforeach
                    ...
                    @foreach($edit_data as $row2)
                      <tr>
                        ...
                        <td>تم تعديل فاتورة رقم {{$row2['invoice_number']}} ({{$row2['invoice_type']}})</td>
                      </tr>
                    @endforeach
                  @endif  
                 </tbody>
