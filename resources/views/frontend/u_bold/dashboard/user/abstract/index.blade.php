    ...
    <div class="panel-heading">
        <div class="row">
            ...
            <ul class="panel-nav pull-left">
                <li><a class="active al" id="state-all"    href="javascript:void(0)"  link="{{Route('abstract.get_invoices_with_status',[0])}}">{{trans('frontend/sales_invoice.status_All'   )}}</a></li>
                <li><a class="al"       id="state-draft"  href="javascript:void(0)"  link="{{Route('abstract.get_invoices_with_status',[5])}}">{{trans('frontend/sales_invoice.status_Partly_Paid' )}}</a></li>
                <li><a class="al"       id="state-unpaid" href="javascript:void(0)"  link="{{Route('abstract.get_invoices_with_status',[2])}}">{{trans('frontend/sales_invoice.status_Unpaid')}}</a></li>
                <li><a class="al"       id="state-due"    href="javascript:void(0)"  link="{{Route('abstract.get_invoices_with_status',[3])}}">{{trans('frontend/sales_invoice.status_Due'   )}}</a></li>
                <li><a class="al"       id="state-paid"   href="javascript:void(0)"  link="{{Route('abstract.get_invoices_with_status',[4])}}">{{trans('frontend/sales_invoice.status_Paid'  )}}</a></li>
            </ul>
        </div>
    </div>
                    ...
                    <div class="tableBody">
                        <tbody>
                            ...
                            <tr style="">
                                ...
                                <td>
                                    <div class="btns">
                                    <a class="btn btn-primary detail-btn hidden show_btn waves-effect waves-light" href="{{ route('abstract.show' ,$row->id) }}"><i class="fa fa-vcard"></i>  {{trans('frontend/sales_invoice.show')}}</a>

                                    <a class="btn btn-default detail-btn waves-effect waves-light" href="{{ route('abstract.edit',$row->id) }}"><i class="fa fa-edit"></i> تعديل  </a>
                                    {!! Form::open(['method' => 'DELETE','route' => ['abstract.destroy', $row->id],'style'=>'display:inline']) !!}
    ...
    <div class="panel-footer">
        <div class="row">
            <div class="col-md-4 pull-left">
                <a class="btn btn-default waves-effect waves-light" href="{{ route('abstract.create') }}">   {{trans('button.create')}}  </a>
            </div>
        </div>
    </div>
</div>
