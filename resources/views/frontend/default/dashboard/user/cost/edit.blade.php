...
<li class="active"> {{trans('frontend/cost.edit')}} </li>
@endsection
...
@endif
<h3>{{trans('frontend/cost.edit')}}</h3>
<hr>    

            {!! Form::model( $data , ['method' => 'PATCH','route' => ['cost.update', $data->id]]) !!}
...
<div class="form-group">
    ...
    <div class="col-lg-8">
        {!! Form::text('document', null, array('placeholder' => trans('frontend/cost.document'),'class' => 'form-control' )) !!}      
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-lg-8">
        {!! Form::text('status', null, array('placeholder' => trans('frontend/cost.status'),'class' => 'form-control' )) !!}      
    </div>
</div>
