...
<li class="active"> {{trans('frontend/user.bank_account_create')}} </li>
@endsection
...
@endif
<h3>{{trans('frontend/user.bank_account_create')}}</h3>
<hr>    

{!! Form::open( ['method' => 'POST','route' => [ 'profile.bankaccount.store']]) !!}     
