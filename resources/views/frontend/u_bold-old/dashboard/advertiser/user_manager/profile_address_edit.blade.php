...
<li class="active"> {{trans('frontend/user.address_edit')}}  </li>
...
@endif    
<h3> {{trans('frontend/user.address_edit')}} </h3>
<hr>

{!! Form::model($data, ['method' => 'PATCH','route' => [ 'profile.address.update', $data->id]]) !!}     
