    ...
    <div class="topbar-main">
        <div class="container">
            ...
            <div class="logo">
                ...
                <a href="index.html" class="logo"><span>Dibuh</span> Gate </a>
                </div>
                <!-- End Logo container-->
                ...
                <div class="menu-extras">
                    ...
                    <ul class="nav navbar-nav navbar-right pull-right">
                        ...
                        <li class="navbar-c-items">
                           <a href="#" data-target="#" class=" waves-effect waves-light" data-toggle="dropdown" aria-expanded="true">
                              Setings
                          </a>
                      </li>
                  ...
                  <li class="dropdown navbar-c-items">
                    <a href="" class="  waves-effect waves-light profile" data-toggle="dropdown" aria-expanded="true">Logout 
                    </a>
                </li>
