...
class MyCompanyController extends DashboardBaseController {
    protected $userType = 'user';
    protected $module = 'my_company';
    ...
    public function index(Request $request) {
        ...
        $this->data['countries']=Country::get()->pluck('name', 'id')->all();
        $this->data['governorates']=Governorate::get()->pluck('name', 'id')->all();
...
//          dd($request);
    ...
    public function invoices(Request $request){
        ...
        $this->data['page_title'] =   trans('جميع الفواتير المستلمة') ;
        $this->data['user_id'] = Auth::user()->id;
        $this->data['data'] = '';
        return  $this->view($this->userType . '.'.$this->module.'.'.'invoices', $this->data);
    }
