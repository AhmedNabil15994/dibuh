...
class UserManagerController extends DashboardBaseController {
    ...
    public function index() {
        ...
        $this->data['country']   = Country::where('id','=',$country_id)->first();
        $this->data['governorate'] = \DB::table('governorates')->where('id','=',$governorate_id)->first();
...
//**********************************************************************************************************//     
    ...
    public function editUserMang(Request $request){
       if($request->password == ''){
           \DB::table('user_profiles')->where('user_id',$request->id)
                            ->update([
                                ...
                                'comercial_no'   =>  $request->comercial_no,
                                'tax_file_no'    =>  $request->tax_file_no,
        ...
        $validator = $this->validator($request->all(), $master);
        ...
        BankAccount::updateOrCreate(['user_id'=>$request->id],[
                'bank_data_type_id' =>  $request->bank_data_type_id,
