...
class AbstractInvoice extends Model {
    ...
    public function abstractInvoiceItems() {
        return $this->hasMany('App\Models\AbstractInvoiceItem');
    }   
    
    
    public function detail()
    {
        return $this->hasMany('App\Models\AbstractInvoiceItem','abstract_invoice_id','id');
    }   
    
    
    public function getDetailsCountAttribute()
    {
        return $this->hasMany('App\Models\AbstractInvoiceItem','abstract_invoice_id','id')->count();
    }      
