...
class CostOther extends Model {
    ...
    protected $fillable = array('invoice_number', 'contact_id', 'contact_name', 'address', 'total_value',
     ...
     public function costOtherItems() {
        return $this->hasMany('App\Models\CostOtherItem');
    }   
    
    
    public function detail()
    {
        return $this->hasMany('App\Models\CostOtherItem','cost_other_id','id');
    }   
    
    
    public function getDetailsCountAttribute()
    {
        return $this->hasMany('App\Models\CostOtherItem','cost_other_id','id')->count();
    }      
