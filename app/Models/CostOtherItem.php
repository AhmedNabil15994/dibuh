...
class CostOtherItem extends Model {

    //
    protected $appends = ['account','amountAfterDiscount','taxes'];
    protected $table = 'costs_other_items';
    protected $fillable = array('cost_other_id', 'product_id', 'product_name',
        'quantity', 'price', 'tax', 'discount','amount','unit_id','account_id');


    public function cost() {
        return $this->belongsTo('App\Models\CostOther');
    }
    ...
    {
        return $this->belongsToMany('App\Models\Tax', 'taxes_to_cost_other_items', 'cost_item_id', 'tax_id');
    }
