...
class CrudViewCommand extends Command
{
    ...
    public function handle()
    {
        ...
        $this->roleName = strtolower($this->option('role-name'));
        $this->roleNameCap = ucwords($this->roleName);
        $this->roleNameSingular = str_singular($this->roleName);        
    ...
    public function templateIndexVars($newIndexFile)
    {
        ...
        File::put($newIndexFile, str_replace('%%roleName%%', $this->roleName, File::get($newIndexFile)));        
        File::put($newIndexFile, str_replace('%%roleCapName%%', $this->roleNameCap, File::get($newIndexFile)));                
    ...
    public function templateCreateVars($newCreateFile)
    {
        ...
        File::put($newCreateFile, str_replace('%%roleName%%', $this->roleName, File::get($newCreateFile)));        
        File::put($newCreateFile, str_replace('%%roleNameCap%%', $this->roleNameCap, File::get($newCreateFile)));           
    ...
    public function templateEditVars($newEditFile)
    {
        ...
        File::put($newEditFile, str_replace('%%roleName%%', $this->roleName, File::get($newEditFile))); 
        File::put($newEditFile, str_replace('%%roleNameSingular%%', $this->roleNameSingular, File::get($newEditFile)));        
        File::put($newEditFile, str_replace('%%roleNameCap%%', $this->roleNameCap, File::get($newEditFile)));             
    ...
    public function templateShowVars($newShowFile)
    {
        ...
        File::put($newShowFile, str_replace('%%roleName%%', $this->roleName, File::get($newShowFile))); 
        File::put($newShowFile, str_replace('%%roleNameSingular%%', $this->roleNameSingular, File::get($newShowFile)));        
        File::put($newShowFile, str_replace('%%roleNameCap%%', $this->roleNameCap, File::get($newShowFile)));               
