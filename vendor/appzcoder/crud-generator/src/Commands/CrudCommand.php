...
class CrudCommand extends Command
{
    ...
    public function handle()
    {
        ...
        $this->call('crud:view', ['name' => $name, '--fields' => $fields, '--validations' => $validations, '--view-path' => $viewPath, '--route-group' => $routeGroup, '--localize' => $localize, '--pk' => $primaryKey,'--role-name'=>$roleName]);
        if ($localize == 'yes') {
